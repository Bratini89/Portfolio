      ...
      <Container className="text-center m-auto items-center flex">
        <Row>
          <Col className="m-auto">
            ...
            <Button className="font-bold mb-2" href="https://certificates.academlo.com/en/credentials/carlosbratini576331" target="_blank" variant="outline-info" size="sm"> <a href={cv} download="Developer-Carlos-Bratini-CV" >Download CV</a></Button>
          </Col>
          <Col>
            <Card
              className="m-auto"
              ...
              <Card style={{ width: "18rem", boxShadow: "3px 3px 10px 3px lightblue" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text className="my-2 text-base font-normal text-stone-500 text-sm">
                    <ul>
                      <li>1. Foundations in Html, Css and Javascript module.</li>
                  ...
                  <br />
                  <Button className="font-bold" href="https://certificates.academlo.com/en/credentials/carlosbratini576331" target="_blank" variant="outline-info" size="sm">Click me  to watch 4 certificates verified</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col>
              <Card style={{ width: "18rem", boxShadow: "3px 3px 10px 3px lightblue" }}>
                ...
                <Card.Body>
                  ...
                  <br />
                  <Button className="font-bold" href="https://ecommerce-bratini.onrender.com/api/v1/docs/#/" target="_blank" variant="outline-info" size="sm">Click me to watch the certificate verified</Button>
                </Card.Body>
              </Card>
            </Col>
          </Row>
