  ...
  return (
    <div id="projects" className="max-w-[1040px]  m-auto md:pl-20 p-4 py-16">
      ...
      <Row xs={1} md={2} xl={3} className="g-4 ">
        <Col>
          <Card data-aos="zoom-in-up" style={{boxShadow: "3px 3px 10px 3px lightblue"}}>
        ...
        <Col>
          <Card data-aos="flip-left" style={{boxShadow: "3px 3px 10px 3px lightblue"}}>
        ...
        <Col>
          <Card data-aos="flip-right" style={{boxShadow: "3px 3px 10px 3px lightblue"}}>
