          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text className="text-center my-2 text-base font-normal text-stone-500">
                ...
                <br />
                <Button
                  href="https://heartfelt-pika-3b1514.netlify.app/"
                  target="_blank"
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text className="text-center my-2 text-base font-normal text-stone-500">
                ...
                <br />
                <Button
                  href="https://weatherapp-88.netlify.app/"
                  target="_blank"
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text className="text-center my-2 text-base font-normal text-stone-500">
                ...
                <br />
                <Button
                  href="https://rickandmorty89.netlify.app/"
                  target="_blank"
        ...
        <Col>
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text className="text-center my-2 text-base font-normal text-stone-500">
                React Js, Redux, React-Route, Axios, UseForm, UseNavigate, Apis
                y CSS3, and others dependencies.
                <br />
                <br />
                <Button
                  href="https://pokeapi-1989.netlify.app/"
                  target="_blank"
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text className="text-center my-2 text-base font-normal text-stone-500">
                ...
                <br />
                <Button
                  href="https://ramdon-quote.netlify.app/"
                  target="_blank"
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text className="text-center my-2 text-base font-normal text-stone-500">
                ...
                <br /> <br />
                <Button
                  href="https://ecommerce-reactt.netlify.app/"
                  target="_blank"
        ...
        <Col>
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text className="text-center my-2 text-base font-normal text-stone-500">
                Node Js, PostgreSQL, Express, Sequelize, Swagger, Render, API
                Rest, Database and others dependencies.
                <br />
                <br />
                <Button
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text className="text-center my-2 text-base font-normal text-stone-500">
                ...
                <br />
                <Button
                  href="https://marvelous-brigadeiros-f2ed19.netlify.app/"
                  target="_blank"
                  variant="outline-info"
                  size="sm"
                >
